...
public class FDOmenu implements Initializable{
	...
	public void switchToflightSchedule(MouseEvent event) throws IOException {
		...
		root = FXMLLoader.load(getClass().getResource("FDOflights.fxml"));
   ...
   public void customerBooking(MouseEvent event) throws IOException {
		...
		root = FXMLLoader.load(getClass().getResource("FDObookings.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
   ...
   public void cancelBooking(MouseEvent event) throws IOException {
		...
		root = FXMLLoader.load(getClass().getResource("FDOcancelbook.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
   ...
   public void Complain(MouseEvent event) throws IOException {
		...
		root = FXMLLoader.load(getClass().getResource("FDOcomplain.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
	}
   public void Myprofile(MouseEvent event) throws IOException {

		root = FXMLLoader.load(getClass().getResource("FDOprofile.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
