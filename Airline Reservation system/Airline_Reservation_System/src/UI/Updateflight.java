...
public class Updateflight implements Initializable {
	...
	public void updateflight(MouseEvent event) throws IOException {
        ...
        else if (src.equals(dst) && !src.equals("") && !dst.equals("")) {
			
        	label.setText("Source and destination can't be equal");	
		}
		else if (matcher.matches()) {
            
			label.setText("Capacity must be only digits");
        }
        else if (!src.equals("Peshawer") && !src.equals("Lahore") && !src.equals("Faisalabad") && !src.equals("Islambad") && !src.equals("Multan") && !src.equals("Karachi")) {
			
        	label.setText("First letter must be capital or city Invalid");
		}
        else if (!dst.equals("Peshawer") && !dst.equals("Lahore") && !dst.equals("Faisalabad") && !dst.equals("Islambad") && !dst.equals("Multan") && !dst.equals("Karachi")) {
